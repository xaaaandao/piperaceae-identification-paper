...
for threshold in 5 10 20; do
	for regioes in Centro-Oeste; do
...
# 		$py read_result.py -i /media/xandao/c2f58d30-ff2c-47f7-95af-91ad6fd69760/resultados/george/specific_epithet/new --threshold ${threshold} -o /media/xandao/c2f58d30-ff2c-47f7-95af-91ad6fd69760/resultados/george/specific_epithet/${color}/sheets_${threshold} -c ${color} --taxon specific_epithet	
# 	done
# done
