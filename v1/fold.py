...
class Fold:
    ...
    def run(self, backend, classifier, data_augmentations, **kwargs):
        self.x_train, self.y_train, self.filenames_train = split_dataset(self.idx_train, self.dataset.n_features, self.dataset.patch, self.dataset.x, self.dataset.y, self.dataset.fake_filenames)
        self.x_test, self.y_test, _ = split_dataset(self.idx_test, self.dataset.n_features, self.dataset.patch, self.dataset.x, self.dataset.y, self.dataset.fake_filenames)
