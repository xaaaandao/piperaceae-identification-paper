...
def load_dataset_informations(input):
    ...
    # input_path = input_path.replace('/home/none/Imagens', '/media/kingston500/mestrado/dataset') # RTX 3080
    input_path = input_path.replace('/media/kingston500/mestrado/dataset', '/home/none/Imagens') # RTX 3060
