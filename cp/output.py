...
def save(best_params, cfg, classifier_name, dataset, list_result_fold, list_time, n_features, path):
    save_fold(cfg, classifier_name, dataset, list_result_fold, list_time, path)
    save_mean(best_params, list_result_fold, list_time, n_features, path)
...
def save_mean(best_params, list_result_fold, list_time, n_features, path):
    ...
    dataframe_mean = pandas.DataFrame(
        ...
        ["mean_time_sec", "mean_time_millisec", "mean_time_min", "mean_time_hour_min_sec", "std_time",
         ...
         "best_mean_std", "best_fold", "best_rule", "best_fold_accuracy", "best_fold_accuracy_per", "best_params", "n_features"])
